          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {corporateIcons.map((item, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="mobile-icon-text p-3 sm:p-4 bg-white/10 rounded-lg backdrop-blur-sm hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
                >
                  <div className="flex-shrink-0 mobile-feature-icon w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 rounded-lg">
